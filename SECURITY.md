...
You are not allowed to search for security vulnerabilities on any hosted service of Dailymile without the consent of the party hosting it.
Dailymile is open source software and can be installed for testing and security issues on your own infrastructure.
