...
You are not allowed to search for security vulnerabilities on any hosted service of GoMiler without the consent of the party hosting it.
GoMiler is open source software and can be installed for testing and security issues on your own infrastructure.
