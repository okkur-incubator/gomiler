...
Thank you for your interest in contributing to Dailymile.  
This guide helps make contributing to Dailymile simple and efficient for everyone.

### First contribution

If you are starting out contributing to Dailymile, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/okkur/dailymile/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the Dailymile wants to achieve, please open up an issue first.
